...
public static class Number {
  ...
  public static IEnumerable<T> Interval<T>(T from, T to) where T : IIncrementOperators<T>, IComparisonOperators<T, T, bool> {
  ...
  public static T2 Sum<T1, T2>(T1 from, T1 to, Func<T1, T2> f) where T1 : IIncrementOperators<T1>, IComparisonOperators<T1, T1, bool> where T2 : IAdditionOperators<T2, T2, T2>
...
public readonly struct Fraction : 
  IEquatable<Fraction>, IComparable<Fraction>, IComparisonOperators<Fraction, Fraction, bool>,
